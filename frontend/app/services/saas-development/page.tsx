...
import {
  saasCaseStudies as caseStudies,
  saasTools,
  saasSteps as steps,
  saasWayOfWorkingCards,
  saasStats,
} from '@/lib/services/saasDevelopmentConfig';



// Data is imported from @/lib/services/saasDevelopmentConfig
  ...
  return (
    <main className="min-h-screen bg-black text-white selection:bg-red-500/30 font-sans overflow-x-hidden scroll-smooth">
      ...
      >
        ...
        <h1 className="text-6xl md:text-7xl font-bold tracking-tighter mb-4">SaaS Development</h1>
        <p className="text-gray-400 text-sm md:text-base mb-16 tracking-wide">Building Scalable, Multi-Tenant Cloud Solutions</p>
        ...
        <div className="max-w-6xl mx-auto p-12 md:p-20 rounded-[40px] bg-[#0a0a0a] border border-red-900/20 backdrop-blur-xl relative">
          ...
          <h2 className="text-3xl md:text-4xl font-bold mb-6 tracking-tight mt-4 text-white">Innovative Software for Global Reach</h2>
          <p className="max-w-4xl mx-auto text-gray-400 leading-relaxed text-sm md:text-base mb-10">
At HoocAI Solution, we help startups and enterprises turn software into a service. We focus on building high-availability platforms that reduce operational costs and provide a seamless experience for thousands of concurrent users. Our approach ensures your product is secure, fast, and ready for a subscription-based economy.          </p>
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          {saasWayOfWorkingCards.map((card, i) => (
            <motion.div 
              variants={fadeInUp}
