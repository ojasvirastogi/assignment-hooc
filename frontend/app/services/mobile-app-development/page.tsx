...
import {
  mobileCaseStudies as caseStudies,
  mobileTechStack as techStack,
  mobileSteps as steps,
  mobileWayOfWorkingCards,
  mobileStats,
} from '@/lib/services/mobileAppConfig';



// Data is imported from @/lib/services/mobileAppConfig
  ...
  return (
    <main className="min-h-screen bg-black text-white selection:bg-red-500/30 font-sans overflow-x-hidden scroll-smooth">
      ...
      >
        ...
        <h1 className="text-6xl md:text-7xl font-bold tracking-tighter mb-4">Mobile App Development</h1>
        <p className="text-gray-400 text-sm md:text-base mb-16 tracking-wide">Creating Powerful Apps for a Mobile-First World</p>
        ...
        <div className="max-w-6xl mx-auto p-12 md:p-20 rounded-[40px] bg-[#0a0a0a] border border-red-900/20 backdrop-blur-xl relative">
          ...
          <h2 className="text-3xl md:text-4xl font-bold mb-6 tracking-tight mt-4 text-white">Your Business, Right in Your Users Pocket</h2>
          <p className="max-w-4xl mx-auto text-gray-400 leading-relaxed text-sm md:text-base mb-10">
            At HoocAI Solution, we understand that a mobile app is more than just a smaller version of a website. Its a powerful tool for engagement. We build apps that leverage device features like GPS, push notifications, and biometric security to provide a rich, integrated experience that keeps your customers coming back.
          </p>
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          {mobileWayOfWorkingCards.map((card, i) => (
            <motion.div 
              variants={fadeInUp}
      ...
      {/* 3. PROCESS STEPS - UPDATED TO MATCH REFERENCE IMAGE 1 */}
      <motion.section 
        initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeInUp}
      ...
      {/* 5. TECH STACK BUBBLE ANIMATION - UPDATED TO MATCH REFERENCE IMAGE 2 */}
      <motion.section 
        initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeInUp}
        ...
        <div className="rounded-[40px] bg-gradient-to-b from-[#1a0a0a] to-black border border-red-900/30 overflow-hidden relative p-16 md:p-24 text-center">
           <div className="relative z-10 flex flex-col items-center">
              ...
              <div className="bg-white/5 border border-white/10 px-4 py-2 rounded-full text-xs font-medium text-gray-400 mb-10 flex items-center gap-2">
                <span className="w-2 h-2 bg-red-500 rounded-full animate-pulse shadow-[0_0_10px_rgba(239,68,68,1)]" /> Mobile Solutions
              </div>
